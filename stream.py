...
st.sidebar.write("""<p style='font-size: 9px;'>This Web-App is designed to facilitate B2B email blasts for PT Nestlé Indonesia made by Nestlé Management Trainee 2023 (Nestea)</p>""", unsafe_allow_html=True)
st.sidebar.write("""<p style='font-size: 8px;'>For any inquiries, error handling, or assistance, please feel free to reach us through Email: Ananda.Cahyo@id.nestle.com</p>""", unsafe_allow_html=True)
