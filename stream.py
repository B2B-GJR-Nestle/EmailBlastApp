...
if feature == "Promotion":
    ...
    template_path = st.file_uploader("Upload Promotion File", type=["docx", "pdf"])
...
default_body = """
Yth. Bapak/Ibu {CompanyName}, di Tempat
Semoga Bapak/Ibu keadaan baik.
Saya mewakili tim PT. Nestlé Indonesia dengan senang hati ingin berbicara tentang peluang kerjasama program feeding karyawan yang dapat memberikan nilai tambah bagi perusahaan Anda.
...
Untuk informasi lebih lanjut seputar produk listing dan harga, Anda dapat menemukannya dalam dokumen yang saya lampirkan.
Kami sangat terbuka untuk berdiskusi lebih lanjut atau menjawab pertanyaan yang mungkin Anda miliki.
